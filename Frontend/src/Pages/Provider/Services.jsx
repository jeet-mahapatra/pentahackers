...
//       {/* LEFT PANEL (FIXED SAME HEIGHT) */}
//       <div className="w-1/3 bg-white p-6 rounded-xl shadow flex flex-col h-[320px]">
...
//         {/* CONTENT AREA (optional scroll if long) */}
//         <div className="mt-4 text-sm text-gray-600 space-y-2 overflow-y-auto">
...
//       {/* RIGHT PANEL */}
//       <div className="flex-1 bg-white p-6 rounded-xl shadow flex flex-col h-[320px]">
...
const MyServices = () => {
  ...
  return (
    <div className="flex gap-6 p-6 h-full bg-[#070A1A] text-white">

      {/* LEFT PANEL */}
      <div className="w-1/3 bg-slate-800 p-6 rounded-xl shadow flex flex-col h-[320px] border border-slate-700">
