...
const ProviderLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#070A1A] text-white">
      ...
      {/* ================= SIDEBAR ================= */}
      <div
        className={`fixed md:static z-30 h-full w-64 bg-slate-800/80 backdrop-blur-xl border-r border-slate-700 flex flex-col justify-between p-5 transition-transform duration-300
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* TOPBAR */}
        <div className="flex justify-between items-center bg-slate-800/80 backdrop-blur-xl border-b border-slate-700 px-4 md:px-6 py-4">
          ...
          <div className="flex items-center gap-3 md:gap-6 ml-auto">
            ...
            {/* USER */}
            <span className="font-medium text-slate-200 text-xs md:text-sm hidden sm:inline">
              {user?.username || "Provider"}
            </span>

            <button
              onClick={handleLogout}
              className="bg-red-500 text-white px-3 md:px-4 py-1 rounded-lg text-sm"
            >
              Logout
            </button>
        ...
        {/* MAIN CONTENT */}
        <div className="flex-1 overflow-y-auto p-4 md:p-6 scroll-smooth bg-[#070A1A]">
          <Outlet />
        </div>
