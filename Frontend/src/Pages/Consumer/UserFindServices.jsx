...
//               <div
//                 key={p._id}
//                 className="bg-white rounded-2xl shadow-md p-5 transition transform hover:-translate-y-2 hover:shadow-xl duration-300"
//               >
...
//           <div className="bg-white p-6 rounded-2xl w-[400px] animate-fadeIn">
